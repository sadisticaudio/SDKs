...
/** @defgroup AAXHostShell_Commands AAXHostShell command interface
 ...
 list data. For a simpler interface, wrap this interface in language-specific utilities such as RAII
 C++ classes.
...
/**	@brief Instantiate or deinstantate a plug-in
 ...
 @ingroup AAXHostShell_Commands
 */
AAXHShell_API(AAXHShell_TResult) AAXHShell_PushCommandInstantiateEffectForContext(AAXHShell_TCommandListID inCommandListID, AAXHShell_TCommandListDataID inID, AAXHShell_TCommandListDataID inEffectIndexID, AAXHShell_TCommandListDataID inHostContextID, AAXHShell_TCommandListDataID outInstanceID);
